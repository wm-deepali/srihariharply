    ...
    <div class="os-form-page">
        ...
        <form method="POST" action="{{ isset($client) ? route('admin.client.update', $client->id) : route('admin.client.store') }}" enctype="multipart/form-data" class="save-form">
            ...
            <div class="section-card">
                <div class="section-card-header"><h5>Client Image{{ isset($client) ? '' : 's' }}</h5></div>
                <div class="section-card-body">
                    ...
                    @else
                        <div class="field-group">
                            ...
                            <div class="field-hint">Recommended size 100×50px. Select multiple files to add them all at once.</div>
                        </div>
                    @endisset
                </div>
            </div>
