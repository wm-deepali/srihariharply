    ...
    <div class="app-content content container-fluid">
        <div class="os-page">
            ...
            <div class="os-page-header">
                <div>
                    <h1>Picture Gallery — Image Category</h1>
                    <div class="crumb"><a href="{{ route('admin.dashboard') }}">Dashboard</a><span>›</span>Image Category</div>
                </div>
                <a href="{{ route('admin.gallery.create') }}" class="btn-primary-dash"><i class="fa fa-plus"></i> Add Image Category</a>
            </div>
            ...
            <div class="os-card">
                    ...
                    <form method="GET">
                        <div class="filter-row">
                            ...
                            <div class="filter-actions">
                                ...
                                <a href="{{ route('admin.gallery.index') }}" class="btn-filter-reset"><i class="fa fa-refresh"></i> Reset</a>
                            </div>
                        </div>
                    </form>
                </div>
                ...
                <div class="os-table-wrap">
                    ...
                    <table class="os-table">
                        <thead>
                            <tr>
                                <th><a href="{{ galSortUrl('id') }}" class="sort-link">ID</a></th>
                                <th><a href="{{ galSortUrl('title') }}" class="sort-link">Category Name</a></th>
                                <th><a href="{{ galSortUrl('status') }}" class="sort-link">Status</a></th>
                                ...
                                <tr id="row{{ $item->id }}">
                                    ...
                                    <td>
                                        <div style="display:flex;gap:6px">
                                            <a href="{{ route('admin.gallery.edit', $item->id) }}" class="action-btn"><i class="fa fa-pencil"></i></a>
                                ...
                                <tr>
                                    <td colspan="4">
                                        <div class="empty-state">
                                            <div class="empty-icon"><i class="fa fa-camera-retro"></i></div>
                                            <strong>No image categories found</strong>
                                            <p>Add a new image category to get started.</p>
                                            <a href="{{ route('admin.gallery.create') }}" class="btn-primary-dash"><i class="fa fa-plus"></i> Add Image Category</a>
                                        </div>
                                    </td>
                                </tr>
                ...
                <div class="os-pagination">{{ $galleries->links('pagination::bootstrap-4') }}</div>
            </div>
        </div>
    </div>
</div>
...
function deleteItem(id) {
    ...
    .then((result) => {
        if (result.isConfirmed) {
            $.ajax({
                url: "{{ url('admin/gallery') }}/" + id, type: 'DELETE', data: { _token: "{{ csrf_token() }}" },
