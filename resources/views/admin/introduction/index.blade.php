    ...
    <div class="app-content content container-fluid">
        <div class="os-form-page">
            <div class="page-header">
                <div>
                    <h1>Home Page Mgmt — Introduction</h1>
                    <div class="crumb"><a href="{{ route('admin.dashboard') }}">Dashboard</a><span>›</span>Introduction</div>
                </div>
            </div>
            ...
            <form method="POST" action="{{ route('admin.introduction.update', $introduction->id) }}" class="save-form">
                @csrf
                @method('PUT')

                <div class="section-card">
                    <div class="section-card-header"><h5>Introduction Details</h5></div>
                    <div class="section-card-body">
                        <div class="field-group">
                            <label class="field-label">Title</label>
                            <input type="text" name="title" class="field-input" value="{{ old('title', $introduction->title) }}" placeholder="Title">
                        </div>
                        <div class="field-group">
                            <label class="field-label">Content</label>
                            <textarea name="content" id="content" class="field-textarea">{{ old('content', $introduction->content) }}</textarea>
                        </div>
                    </div>
                </div>
