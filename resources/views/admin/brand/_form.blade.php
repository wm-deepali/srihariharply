...
<div class="app-content content container-fluid">
    <div class="os-form-page">
        <div class="page-header">
            <div>
                ...
                <div class="crumb">
                    ...
                    <a href="{{ route('admin.brand.index') }}">Brand</a><span>›</span>
                    {{ isset($brand) ? 'Edit' : 'Add' }}
                </div>
            </div>
        </div>
        ...
        <form method="POST" action="{{ isset($brand) ? route('admin.brand.update', $brand->id) : route('admin.brand.store') }}" class="save-form">
            @csrf
            ...
            <div class="action-bar">
                ...
                <button type="submit" class="btn-primary-dash save-btn"><i class="fa fa-save"></i> {{ isset($brand) ? 'Update' : 'Save' }}</button>
            </div>
        </form>
    </div>
</div>
